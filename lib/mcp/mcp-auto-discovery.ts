...
function buildToolRegistrationInput(
  ...
  return {
    ...
    tools: tools.map((tool) => ({
      ...
      version: "1.0.0",
      capability: tool.capability as typeof import("@/lib/settings/platform-config").MCP_CAPABILITY_NAMES[number],
      boundary: tool.boundary,
      riskLevel: tool.riskLevel,
      requiresApproval: tool.requiresApproval,
      resultMappings: tool.resultMappings as Array<typeof import("@/lib/settings/platform-config").MCP_RESULT_MAPPINGS[number]>,
