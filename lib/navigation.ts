...
export const prototypeNavigation: NavigationItem[] = [
  ...
  { title: "项目管理", href: "/projects", icon: FolderKanban, section: "总览", badge: "12", description: "管理项目推进、范围与阶段状态" },
  { title: "审批中心", href: "/approvals", icon: ClipboardCheck, section: "总览", badge: "6", description: "集中处理跨项目高风险动作审批" },
