...
- `mcps/fscan-mcp-server` – Host/port scanning, brute-force, and vulnerability scanning (`fscan_port_scan`, `fscan_brute`, `fscan_vuln_scan`). Runner fixed to use `-json` flag (not `-f json`) for fscan 1.8.4 compatibility.
